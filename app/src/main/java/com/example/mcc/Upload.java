...
public class Upload extends AppCompatActivity {
    ...
    String time;
    String Email;
    private String UploadUrl = "http://192.168.43.170/mcc/Upload.php";
    Button button2;
    TextView textView;
    ...
    public void uploadImage(View view) {
            ...
            public void processFinish(String s) {
                if (s.contains("Uploaded_Success")) {
                    ...
                    try {
                        ...
                        Intent intent2 = new Intent(Upload.this,Page1.class);
        ...
        task.execute("http://192.168.43.170/mcc/Upload.php");
